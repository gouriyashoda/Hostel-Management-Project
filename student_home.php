					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="enroll_student_view.php">My Profile </a></li>
                                <li><a href="academic_details.php">Academic details </a></li>
								<li><a href="mess_bill.php">mess bill</a></li>
								<li><a href="attendence_details.php">attendance</a></li>
								<li><a href="menu_view.php">mess menu</a></li>
